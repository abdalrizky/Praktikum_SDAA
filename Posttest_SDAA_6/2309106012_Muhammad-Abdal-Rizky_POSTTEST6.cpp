...
int fibonacciSearch(Node *head, double rating) {
    ...
    while (fibM > 1) {
        ...
        if (temp->data.rating < rating) {
            ...
            offset = i;
        } else if (temp->data.rating > rating) {
            fibM = fibMMm2;
    ...
    if (fibMMm1 && current->data.rating == rating) {
        return offset + 1;
    }
...
int jumpSearch(Node *head, double rating) {
    Node *duplicate = duplicateList(head);
    mergeSort(&duplicate);

    int step = sqrt(jumlahTempatNongkrong);
    Node *prev = nullptr;
    Node *current = duplicate;
    int idx = 0;

    while (current != nullptr && current->data.rating < rating) {
        prev = current;
...
int main() {
    ...
    do {
        ...
        cout << "[5] Cari tempat nongkrong favorit berdasarkan rating dengan Fibonacci Search" << endl;
        cout << "[6] Cari tempat nongkrong favorit berdasarkan rating dengan Jump Search" << endl;
        cout << "[7] Cari tempat nongkrong favorit berdasarkan nama dengan Boyer-Moore" << endl;
        ...
        case 5: {
            ...
            if (mode == 1) {
                ...
                cin >> rating;
                int result = fibonacciSearch(top, rating);
                if (result == -1) {
                    cout << "Rating tidak ditemukan." << endl;
                } else {
                    cout << "Rating ditemukan pada indeks ke-" << result << endl;
                }
            } else {
                if (front == nullptr) {
                    cout << "Belum ada tempat nongkrong yang ditambahkan." << endl;
                ...
                cout << "Masukkan rating yang ingin dicari: ";
                cin >> rating;
                int result = fibonacciSearch(front, rating);
                if (result == -1) {
                    cout << "Rating tidak ditemukan." << endl;
                } else {
                    cout << "Rating ditemukan pada indeks ke-" << result << endl;
        ...
        case 6: {
            ...
            if (mode == 1) {
                ...
                cout << "Masukkan rating yang ingin dicari: ";
                cin >> rating;
                int result = jumpSearch(top, rating);
                if (result == -1) {
                    cout << "Rating tidak ditemukan." << endl;
                } else {
                    cout << "Rating ditemukan pada indeks ke-" << result << endl;
                ...
                cout << "Masukkan rating yang ingin dicari: ";
                cin >> rating;
                int result = jumpSearch(front, rating);
                if (result == -1) {
                    cout << "Rating tidak ditemukan." << endl;
                } else {
                    cout << "Rating ditemukan pada indeks ke-" << result << endl;
        ...
        case 7: {
            ...
            if (mode == 1) {
                ...
                cout << "Masukkan nama tempat nongkrong yang ingin dicari: ";
                cin.ignore();
                getline(cin, nama);
                int result = boyerMooreSearch(top, nama);
                if (result == -1) {
                    cout << "Nama dengan pola tersebut tidak ditemukan." << endl;
                } else {
                    cout << "Nama dengan pola tersebut ditemukan pada indeks ke-" << result << endl;
                }
            } else {
                if (front == nullptr) {
                    cout << "Belum ada tempat nongkrong yang ditambahkan." << endl;
                ...
                cin.ignore();
                getline(cin, nama);
                int result = boyerMooreSearch(front, nama);
                if (result == -1) {
                    cout << "Nama dengan pola tersebut tidak ditemukan." << endl;
                } else {
                    cout << "Nama dengan pola tersebut ditemukan pada indeks ke-" << result << endl;
